...
export default function CartItem(props) {
  ...
  function removeFromCart(id) {
    ...
    addToast(props.data.productname+" ha sido eliminado con éxito de su carrito", { appearance: 'info', autoDismiss: true, })
  ...
  function saveForLater(data) {
    ...
    addToast(props.data.productname+" se ha guardado para compras posteriores", { appearance: 'success', autoDismiss: true, })
      ...
      <tr className="row-cart-item ">
        ...
        <td className="row-cart-item-description-container">
          <div className="row-cart-item-description">
            ...
            <h3 className="product-size">Tamaño: {props.data.selectedSize}</h3>
            <h3 className="product-color">Color: {props.data.color}</h3>
            <h3 className="product-color">Cantidad: {props.data.product_selected_qty}</h3>
            ...
            >
              <button className="btn-cart-item-action-save-edit">Editar</button>
            </Link>
          </div>
        </td>
