...
export default function Cart() {
  ...
  return (
    <div>
      ...
      <h1 className="text-center">Articulos en tu carrito<span className="cart-header-number-of-items"> {myShoppingCart.length>0 ? myShoppingCart.length+" items": ""}</span></h1>
