...
export default function ProductDetails(props) {
  ...
  if (productStockLevel > 0 && productStockLevel < 100) {
    ...
    stockLevelMessage = `Agotandose, disponibles ${productStockLevel} piezas.`;
  ...
  function  handleAddToCart(data) {
    ...
    addToast(data.productname+" se ha guardado para compras posteriores", { appearance: 'success', autoDismiss: true, })
    ...
    <div className="container-product-details">
      <div className="row">
        ...
        <div className="col-lg-5">
          ...
          <h3>Marca: {ProductDetails.brand}</h3>
          ...
          {productStockLevel === 0 ? (
            <h2 className="out-of-stock-notice">
              <FontAwesomeIcon icon={faChartBar} /> Agotado
            </h2>
          ) : (
