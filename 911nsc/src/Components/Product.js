...
export default function Product(props) {
  ...
  function  handleAddToCart(data) {
    ...
    addToast(data.productname+" se añadido con éxito a tu carrito", { appearance: 'success', autoDismiss: true, })
  ...
  if (productLevel > 0 && productLevel < 100) {
    ...
    stockLevelMessage = `Agotandose, disponibles ${productLevel} piezas `;
  } else if (productLevel === 0) {
    bannerStockLevel = "product-banner-stock-level-out-of-stock";
    stockLevelMessage = `Agotado`;
  }
              ...
              {props.data.discount > 0 ? (
                <h3>
                  ...
                  <span className="product-price-after-discount">
                    ...
                    new Intl.NumberFormat('en-US', {style: 'currency', currency:'USD'}).format( props.data.price -  (props.data.price * props.data.discount / 100)
                    )
